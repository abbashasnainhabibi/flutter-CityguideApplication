...
import 'package:cityguide/ADMIN_PANEL/Hotel/HotelDatabase.dart';
...
class _AddHotelState extends State<AddHotel> {
  ...
  final HotelDatabase hotelDatabase = HotelDatabase();
  ...
  Future<void> _addHotelToFirestore() async {
    ...
    try {
      await hotelDatabase.addHotelWithImages(
        HotelName: hotelName,
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Error adding hotel. Please try again later.'),
        behavior: SnackBarBehavior.floating,
        backgroundColor: Colors.redAccent,
      ));
    }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                _buildTextField('Hotel Name', hotelNameController),
                SizedBox(height: 16),
                ...
                Center(
                  child: ElevatedButton(
                    onPressed: _addHotelToFirestore,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.green,
                      padding: EdgeInsets.symmetric(
