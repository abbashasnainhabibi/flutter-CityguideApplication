...
import 'dart:convert';
import 'package:cityguide/Restaurant/ParticularRestaurant.dart';
      ...
      builder: (context, snapshot) {
        ...
        if (_searchQuery.isNotEmpty) {
          cities = cities.where((city) {
            var cityName = city['RestaurantName']?.toString().toLowerCase() ?? '';
            return cityName.contains(_searchQuery);
          }).toList();
        }

        return cities.isEmpty
            ? const Center(child: Text('No matching Restaurant found.'))
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String name = city['RestaurantName'] ?? 'Unknown Restaurant';
